...
<center>
<p><a href='homepage.php' class="turnback">Trở về trang chủ</a></p>
        ...
        while($sql_2 = mysqli_fetch_array($sql_1))
        {
            ...
            ?>
                <tr class="a_1" >
                    ...
                    <td align="center" >
                        <a href="update_classroom_teacher.php?id=<?php echo $sql_2["id"] ?>" class="lk_a1" >Sửa</a>
                    </td>
                    <td align="center" >
                        <a href="delete_classroom_teacher.php?id=<?php echo $sql_2["id"] ?>" class="lk_a1" >Xóa</a>
                    </td>
                </tr>
            <?php
        }
