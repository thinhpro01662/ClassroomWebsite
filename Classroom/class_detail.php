                    ...
                    <nav class="navbar navbar-inverse">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                <a class="navbar-brand" href='javascript:history.go(-1)'>Classroom</a>
                            </div>
                            ...
                            <ul>
                                <li><font color="white">
                                <li><a href="homepage.php">Trang chủ</a><br>
                                <li><a href="list_student.php?id=<?php echo $id_lop;?>">Danh Sách Sinh Viên</a></li>
                                <li><a href="add_form_baiviet.php?id=<?php echo $id_lop;?>">Đăng bài</a></li>
                                <li><a href="manage_class_detail.php?id=<?php echo $id_lop;?>">Quản lý bài viết</a>
                            </ul>
                        </div>
                    </nav>
                </td>
